                                    ...
                                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                       ...
                                       <div class="col-md-12 col-sm-12 col-xs-12">
                                         <div class="item form-group">
                                             <label for="school_id" class="col-md-2"><?php echo $this->lang->line('school'); ?> <span class="required">*</span></label>
                                             <div class="col-md-4 col-md-offset-right-6">
                                                    <select  class="form-control  fn_school_id" name="school_id" id="school_id" required="required" onchange="get_class_by_school(this.value);">
                                     ...
                                     <div class="col-md-12 col-sm-12 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <div class="col-md-4 col-md-offset-right-6"> 
                                                <select  class="form-control" name="class_id" id="class_id" required="required" onchange="get_section_by_class(this.value);">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-12 col-sm-12 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-md-offset-right-6">
                                                 <select  class="form-control" name="section_id" id="section_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                         <div class="item form-group">
                                             <label class="col-md-2" ><?php echo $this->lang->line('csv_file'); ?>&nbsp;</label>
                                             <div class="col-md-4 col-md-offset-right-6"> <div class="btn btn-default btn-file">
