                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($schools) && !empty($schools)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'administrator', 'school')){ ?>
                                                    <a  onclick="get_school_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-school-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/school/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_type"><?php echo $this->lang->line('school_type'); ?> <span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="school_type" required="required">
                                                <option value=""><?php echo $this->lang->line('select_board'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['school_type'] == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('ssc'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['school_type'] == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('cbse'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['school_type'] == '2'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('icse'); ?> </option>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="affilication"><?php echo $this->lang->line('affilication'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="affilication"  id="affilication" value="<?php echo isset($post['affilication']) ?  $post['affilication'] : ''; ?>" placeholder="<?php echo $this->lang->line('affilication'); ?> "  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('affilication'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="registration_certificate"><?php echo $this->lang->line('registration_certificate'); ?> <span class="required">*</span> </label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload_reg_certificate'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="registration_certificate" id="registration_certificate"  type="file">
                                            </div>
                                            <div class="help-block"><?php echo form_error('registration_certificate'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="adhar_pan_card"><?php echo $this->lang->line('adhar_pan_card'); ?> <span class="required">*</span> </label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="adhar_pan_card" id="adhar_pan_card"  type="file">
                                            </div>
                                            <div class="help-block"><?php echo form_error('adhar_pan_card'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_address_proof"><?php echo $this->lang->line('school_address_proof'); ?> <span class="required">*</span> </label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload_address_proof'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="school_address_proof" id="school_address_proof"  type="file">
                                            </div>
                                            <div class="help-block"><?php echo form_error('school_address_proof'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="week_off"><?php echo $this->lang->line('week_off'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="week_off"  id="week_off" value="<?php echo isset($post['week_off']) ?  $post['week_off'] : ''; ?>" placeholder="<?php echo $this->lang->line('sample_week_off'); ?> " required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('week_off'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="class_from"><?php echo $this->lang->line('class_from'); ?> <span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="class_from" required="required">
                                                <option value=""><?php echo $this->lang->line('select_class'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_from'] == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('lkg'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_from'] == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('ukg'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_from'] == '2'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('first_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_from'] == '3'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('second_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_from'] == '4'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('third_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_from'] == '5'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('fourth_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_from'] == '6'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('fifth_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_from'] == '7'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('sixth_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_from'] == '8'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('seventh_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_from'] == '9'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('eighth_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_from'] == '10'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('ninth_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_from'] == '11'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('tenth_c'); ?> </option>
                                              
                                            </select>
                                            <div class="help-block"><?php echo form_error('class_from'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="class_to"><?php echo $this->lang->line('class_to'); ?> <span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="class_to" required="required">
                                                <option value=""><?php echo $this->lang->line('select_class'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_to'] == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('lkg'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_to'] == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('ukg'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_to'] == '2'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('first_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_to'] == '3'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('second_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_to'] == '4'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('third_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_to'] == '5'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('fourth_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_to'] == '6'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('fifth_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_to'] == '7'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('sixth_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_to'] == '8'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('seventh_c'); ?> </option>
                                                <option value="0" <?php if(isset($post) && $post['class_to'] == '9'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('eighth_c'); ?> </option>
                                                <option value="1" <?php if(isset($post) && $post['class_to'] == '10'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('ninth_c'); ?> </option>
                                                <option value="2" <?php if(isset($post) && $post['class_to'] == '11'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('tenth_c'); ?> </option>
                                              
                                            </select>
                                            <div class="help-block"><?php echo form_error('class_to'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                    <label><?php echo $this->lang->line('school_start_time'); ?> <span class="required">*</span>
                                    </label>
                                    
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_start_time"  id="add_start_time" value="<?php echo isset($post['school_start_time']) ?  $post['school_start_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_start_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('school_start_time'); ?></div>
                                    
                                </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                      <div class="item form-group">
                                       <label ><?php echo $this->lang->line('school_end_time'); ?> <span class="required">*</span>
                                        </label>
                                    
                                        <input  class="form-control col-md-7 col-xs-12"  name="school_end_time"  id="add_end_time" value="<?php echo isset($post['school_end_time']) ?  $post['school_end_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_end_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('school_end_time'); ?></div>
