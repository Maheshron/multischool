...
<!--
                                    <div class="payment mt-25 bdr-top pt-30">
                                        <a href="#"><img class="img" src="<?php echo IMG_URL; ?>front/payment/1.png" alt="payment-image"></a>
                                    </div>                                   
-->
                                </div>
                            </div>
...
<!--
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>front/icon/social-img1.png" alt="google play"></a></li>
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>front/icon/social-img2.png" alt="app store"></a></li>
-->
                            </ul>
                    </div>
                </div>
