                        ...
                        <ul>                                          
                            <li><span>Language</span> <a href="#">English<i class="lnr lnr-chevron-down"></i></a>
                                ...
                                <ul class="ht-dropdown">
                                    <li><a href="#"><img src="<?php echo IMG_URL; ?>front/header/1.jpg" alt="language-selector">English</a></li>
                                    <li><a href="#"><img src="<?php echo IMG_URL; ?>front/header/2.jpg" alt="language-selector">Francis</a></li>
                                </ul>
                                <!-- Dropdown End -->
                            </li>
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-2 col-md-12">
                            <div class="logo mb-all-30">
                                <a href="index.html"><img src="<?php echo IMG_URL; ?>front/logo/logo2.png" alt="logo-image"></a>
                            </div>
                        </div>
                        <!-- Categorie Search Box Start Here -->
                        <div class="col-lg-8 col-md-8 ml-auto mr-auto col-10">
