                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('teacher/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="national_id"  id="national_id" value="India" placeholder="<?php echo $this->lang->line('national_id'); ?>" type="text" autocomplete="off" readonly>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">                  
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5  class="column-title"><strong><?php echo $this->lang->line('Bank'); ?> <?php echo $this->lang->line('information'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="account_holder"><?php echo $this->lang->line('account_holder'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="account_holder"  id="account_holder" value="<?php echo isset($post['account_holder']) ?  $post['account_holder'] : ''; ?>" placeholder="<?php echo $this->lang->line('account_holder'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('account_holder'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="account_account"><?php echo $this->lang->line('account_account'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="account_account"  id="account_account" value="<?php echo isset($post['account_account']) ?  $post['account_account'] : ''; ?>" placeholder="<?php echo $this->lang->line('account_account'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('account_account'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_name"><?php echo $this->lang->line('bank_name'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_name"  id="bank_name" value="<?php echo isset($post['bank_name']) ?  $post['bank_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('bank_name'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_name'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_branch"><?php echo $this->lang->line('bank_branch'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_branch"  id="bank_branch" value="<?php echo isset($post['bank_branch']) ?  $post['bank_branch'] : ''; ?>" placeholder="<?php echo $this->lang->line('bank_branch'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_branch'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_ifsc"><?php echo $this->lang->line('bank_ifsc'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_ifsc"  id="bank_ifsc" value="<?php echo isset($post['bank_ifsc']) ?  $post['bank_ifsc'] : ''; ?>" placeholder="<?php echo $this->lang->line('bank_ifsc'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_ifsc'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                      ...
                                      <div class="row">                  
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5  class="column-title"><strong><?php echo $this->lang->line('qualification'); ?> <?php echo $this->lang->line('information'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="qualification"  id="qualification" value="<?php echo isset($post['qualification']) ?  $post['account_holder'] : ''; ?>" placeholder="<?php echo $this->lang->line('qualification'); ?>" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="university"  id="university" value="<?php echo isset($post['university']) ?  $post['university'] : ''; ?>" placeholder="<?php echo $this->lang->line('university'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('university'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="yearofpass"><?php echo $this->lang->line('yearofpass'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="yearofpass"  id="yearofpass" value="<?php echo isset($post['yearofpass']) ?  $post['yearofpass'] : ''; ?>" placeholder="<?php echo $this->lang->line('yearofpass'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('yearofpass'); ?></div>
                                        </div>
                                    </div>
                                   
                             <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="certificates"><?php echo $this->lang->line('teacher'); ?> <?php echo $this->lang->line('certificates'); ?> </label>                                           
                                                <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="certificates"  id="certificates" value="" placeholder="<?php echo $this->lang->line('upload'); ?>" type="file">
                                            </div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                            <div class="help-block"><?php echo form_error('certificates'); ?></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php echo form_open_multipart(site_url('teacher/edit/'. $teacher->id), array('name' => 'editteacher', 'id' => 'editteacher', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="account_holder"><?php echo $this->lang->line('account_holder'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="account_holder"  id="account_holder" value="<?php echo isset($teacher->account_holder) ?  $teacher->account_holder : ''; ?>" placeholder="<?php echo $this->lang->line('account_holder'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('account_holder'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="account_account"><?php echo $this->lang->line('account_account'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="account_account"  id="account_account" value="<?php echo isset($teacher->account_account) ?  $teacher->account_account : ''; ?>" placeholder="<?php echo $this->lang->line('account_account'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('account_account'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_name"><?php echo $this->lang->line('bank_name'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_name"  id="bank_name" value="<?php echo isset($teacher->bank_name) ?  $teacher->bank_name : ''; ?>" placeholder="<?php echo $this->lang->line('bank_name'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_name'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_branch"><?php echo $this->lang->line('bank_branch'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_branch"  id="bank_branch" value="<?php echo isset($teacher->bank_branch) ?  $teacher->bank_branch : ''; ?>" placeholder="<?php echo $this->lang->line('bank_branch'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_branch'); ?></div>
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="bank_ifsc"><?php echo $this->lang->line('bank_ifsc'); ?> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="bank_ifsc"  id="bank_ifsc" value="<?php echo isset($teacher->bank_ifsc) ?  $teacher->bank_ifsc : ''; ?>" placeholder="<?php echo $this->lang->line('bank_ifsc'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('bank_ifsc'); ?></div>
                                        </div>
                                    </div>
                                </div>
