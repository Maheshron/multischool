<div class="" data-example-id="togglable-tabs">
  ...
  <li class=""><a href="#tab_bank_info"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-share"></i> <?php echo $this->lang->line('bank'); ?> <?php echo $this->lang->line('information'); ?></a> </li>
 ...
 <div  class="tab-pane fade in " id="tab_bank_info" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $this->lang->line('account_holder'); ?></th>
                        <td><?php echo $teacher->account_holder; ?></td>        
                        
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('account_account'); ?></th>
                        <td><?php echo $teacher->account_account; ?></td>        
                        
                    </tr>

                     <tr>
                        <th><?php echo $this->lang->line('bank_name'); ?></th>
                        <td><?php echo $teacher->bank_name; ?></td>        
                        
                    </tr>

                     <tr>
                        <th><?php echo $this->lang->line('bank_branch'); ?></th>
                        <td><?php echo $teacher->bank_branch; ?></td>        
                       
                    </tr>


                     <tr>
                        <th><?php echo $this->lang->line('bank_ifsc'); ?></th>
                        <td><?php echo $teacher->bank_ifsc; ?></td>        
