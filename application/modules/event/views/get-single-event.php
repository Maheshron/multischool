<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo date($this->global_setting->date_format, strtotime($event->event_from)); ?>
            <?php echo $event->event_fromt; ?></td>
        </tr>
        <tr>
            <th><?php echo $this->lang->line('to_date'); ?> </th>
            <td><?php echo date($this->global_setting->date_format, strtotime($event->event_to)); ?>
              <?php echo $event->event_tot; ?></td>
        </tr>
        <tr>
