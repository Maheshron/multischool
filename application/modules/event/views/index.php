                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('event/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="event_fromt"><?php echo $this->lang->line('from_time'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_fromt"  id="add_event_from" value="<?php echo isset($post['event_fromt']) ?  $post['event_fromt'] : ''; ?>" placeholder="<?php echo $this->lang->line('from_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('event_fromt'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                  ...
                                  <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="event_tot"><?php echo $this->lang->line('to_time'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_tot"  id="add_event_to" value="<?php echo isset($post['event_tot']) ?  $post['event_tot'] : ''; ?>" placeholder="<?php echo $this->lang->line('to_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('event_tot'); ?></div>
                                    </div>
                                </div>
                               ...
                               <?php echo form_open_multipart(site_url('event/edit/'.$event->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_fromt"  id="edit_event_from" value="<?php echo isset($event->event_fromt) ?  $event->event_fromt : $post['event_fromt']; ?>" placeholder="<?php echo $this->lang->line('from_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('event_fromt'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_tot"  id="edit_event_to" value="<?php echo isset($event->event_tot) ? $event->event_tot: $post['event_tot']; ?>" placeholder="<?php echo $this->lang->line('to_time'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('event_tot'); ?></div>
                                    </div>
                                </div>
